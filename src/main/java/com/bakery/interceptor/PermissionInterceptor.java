package com.bakery.interceptor;
...
public class PermissionInterceptor implements HandlerInterceptor{
   ...
   public boolean preHandle(HttpServletRequest request,
      ...
      if (userId == null && (uri.startsWith("/order")  || uri.startsWith("/cart") || uri.startsWith("/wish")
    		   || uri.startsWith("/user/myPage") || uri.startsWith("/inquiry") || uri.startsWith("/like"))) {
      ...
      if (userId != null && uri.startsWith("/user/sign")) {
         response.sendRedirect("/bakery/home-view");
         return false; // 원래 요청에 대해서 컨트롤러 수행 X
      }
