...
public class ProductRestController {
	...
	public Map<String, Object> add(
		...
		//db insert
		productBO.addProduct(productName, file, stock, costPrice, sellingPrice, category);
		//응답값
	...
	public Map<String, Object> update(
			...
			@RequestParam("file") MultipartFile file){
		//db insert
		productBO.updateProductByProductId(productId, productName, file, stock, costPrice, sellingPrice, category);
		//응답값
		Map<String, Object> result = new HashMap<>();
		result.put("code", 200);
		result.put("result", "성공");
